...
[fgc-scoreboard with customization tool](https://github.com/chzylee/fgc-scoreboard-customizations/releases/latest) - This is an easy scoreboard to setup and comes with settings in StreamControl to customize colors of the scoreboard and show/hide a logo at the bottom.
