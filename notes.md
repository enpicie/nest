...
<div style="display: flex; align-items: flex-start; gap: 14px; background: #1e293b; border: 1px solid #334155; border-radius: 0.75rem; padding: 1rem 1.25rem;">
  <img src="assets/enpicie.jpg" style="width: 48px; height: 48px; border-radius: 50%; object-fit: cover; flex-shrink: 0; margin-top: 2px;">
  <div>
    <div style="color: #818cf8; font-weight: 700; font-size: 0.85rem; margin-bottom: 0.4rem;">A Note from enpicie</div>
